...
namespace CustomUIControls
{
    namespace Graphing
    {
        public class C2DPushGraph : Control
        {
            ...
            private DashStyle m_GridDashStyle = DashStyle.Solid;
            ...
            private float  m_LineInterval = 5;
            ...
            public DashStyle GridDashStyle
            {
                set
                {
                    if (m_GridDashStyle != value)
                    {
                        m_GridDashStyle = value;
                        Refresh();
                    }
                }
                get { return m_GridDashStyle; }
            }
            ...
            public void UpdateGraph()
            {
                ...
                {
                    m_MoveOffset =
                        (m_MoveOffset - (int)(((greatestMCount - m_MaxCoords) + 1) * m_LineInterval))
                        % m_GridSize;
                }
            ...
            protected void CalculateMaxPushPoints()
            {
                ...
                m_MaxCoords = (int)((Width - m_OffsetX) / m_LineInterval) + 2
                                   + ((int)((Width - m_OffsetX) % m_LineInterval) != 0 ? 1 : 0);
            ...
            protected void DrawLabels(ref Graphics g)
            {
                ...
                g.DrawString(m_MaxLabel, Font, textBrush,
                              ...
                              2);
                g.DrawString(PeekStr, Font, textBrush,
                              textWidth / 2 - (peekSize.Width / 2),
                              20);
            ...
            protected void DrawGrid(ref Graphics g)
            {
                ...
                gridPen.DashStyle = m_GridDashStyle;
...
*/
            ...
            protected void DrawLines(ref Graphics g)
            {
                foreach (Line line in m_Lines)
                {
                    ...
                    int OffsetX = Width - (int)(line.m_MagnitudeList.Count * m_LineInterval) + 4;
                    ...
                    for (int n = 0; n < line.m_MagnitudeList.Count; ++n)
                    {
                        if (line.m_bShowAsBar)
                        {
                            ...
                            barRect.Width = (int)m_LineInterval - 1;
